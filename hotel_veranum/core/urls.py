...
from .views import home, guest_reserva, all_guests, guest, create_guest, additional_services, restaurant_order, restaurant_order_list, restaurant_order_create, restaurant_order_update, restaurant_order_delete, inventory_item_list, inventory_item_create, inventory_item_update, inventory_item_delete, provider_list, provider_create, provider_update, provider_delete, iniciar_pago, confirmacion_pago, pago_exito, report_selection, generate_report
